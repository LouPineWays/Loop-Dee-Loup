...
script's own header comment for detail. Scenarios 1, 2, 3, 4, 5, and 7 were unaffected in
outcome by either change and are re-recorded below only because they share the same fixture
script and constants as Scenario 6.
